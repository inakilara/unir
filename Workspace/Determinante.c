//
// Escribe un programa que calcule el determinante de una matríz de tamaño arbitrario por el mét de Laplace:
/*
 *
...
double det(double *M,int n) {
    if( n==1) {
        ...
        double res=0;
        for(int j = 0; j<n ;j++) {                                          // El mét de Laplace con i=0 y recorriendo j
